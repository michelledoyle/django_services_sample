...
def encounter_service(encounter_id, person_id=None, first_name=None, last_name=None, zip_code=None):
...
class PubSubToSpannerListenerService:
    ...
    def callback(self, message):
        ...
        encounter_service(encounter_id, person_id, first_name, last_name, zip_code)
